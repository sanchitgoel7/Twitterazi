...
with st.form(key="my_form"):
    ...
    a, b = st.columns([1, 1])
    search_params["query_terms"] = a.text_input("Search term","nike")
    search_params["limit"] = b.slider("Tweet limit", 1, 1000, 200)

    a, b, c, d = st.columns([1, 1, 1, 1])
    search_params["min_replies"] = a.number_input("Minimum replies", 0, 100000, 10)
    search_params["min_retweets"] = b.number_input("Minimum retweets", 0, 100000, 2)
    search_params["min_faves"] = c.number_input("Minimum hearts", 0, 100000, 20)
